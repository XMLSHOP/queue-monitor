        ...
        <div class="flex items-center my-2 -mx-2">
            ...
            <div class="px-2 w-1/8">
                ...
                <select name="type" id="filter_show"
                    ...
                    <option @if($filters['type'] === 'pending') selected
                            @endif value="pending">@lang('Pending')</option>
            ...
            <div class="px-2 w-1/4">
                ...
                <select name="job" id="filter_jobs"
                        class="w-full p-2 bg-gray-200 border-2 border-gray-300 rounded">
                    <option value="all">All</option>
            ...
            <div class="px-2 w-1/4">
                <div class="w-100">
                    <label for="filter_date_from"
                        ...
                        @lang('From')&nbsp;
                        <span v-tooltip:bottom="'{{ __('Counts in: queued, started, finished and failed.') }}'">
